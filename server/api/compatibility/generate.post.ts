...
export default defineEventHandler(async (event) => {
    ...
    const { data: report, error } = await supabase
        ...
        .insert({
            ...
            person1_chart_json: synastry.chart1 as unknown as import('~~/app/types/database.types').Json,
            ...
            person2_chart_json: synastry.chart2 as unknown as import('~~/app/types/database.types').Json,
            synastry_json: { crossAspects: synastry.crossAspects } as unknown as import('~~/app/types/database.types').Json,
            scores: synastry.scores as unknown as import('~~/app/types/database.types').Json,
            content,
            type: 'basic',
        })
        .select()
